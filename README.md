...
これをやって、hplt/purif8にあります。もともとjsonlの元リンクとかも貼ってあったんですが全て削除して、純粋にテキストデータだけになりました。またpufif*.pyでノイズ除去も行った結果、圧縮してないのに3GB程度になりました。1387464192文字です。でも結構記号系があるので、まあ9億文字程度じゃないかなあ?
